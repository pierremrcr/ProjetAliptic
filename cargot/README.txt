...
a persistence unit "cargotPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "cargot\pom.xml":
...
artifacts ("cargot-ejb.jar" and "cargot-web.war") are already built. You can build
